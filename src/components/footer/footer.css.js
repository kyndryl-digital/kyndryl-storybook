...
export default css`
  ...
  * {
  ...
  .cmp-footer__bottom-link .cmp-list__item a {
    font-size: 14px;
    font-weight: 500;
    line-height: 18px;
  }
  ...
  @media (min-width: 1200px) .cmp-footer .cmp-languagenavigation__current-lang {
    white-space: nowrap;
  }
  ...
  .cmp-footer .cmp-languagenavigation__current-lang-icon:before,
  .header__mobile-nav .cmp-languagenavigation__current-lang-icon:before {
  ...
  .cmp-languagenavigation__current-lang-icon:before {
    ...
    transition: transform 0.4s ease-in-out 0.5s,
      -webkit-transform 0.4s ease-in-out 0.5s;
  }

  @media (min-width: 767px) .cmp-footer .cmp-languagenavigation>.cmp-languagenavigation__group {
    right: 0;
  ...
  @media (min-width: 767px) .cmp-footer .cmp-languagenavigation__list {
    max-height: 40vh;
  }

  .cmp-footer .cmp-languagenavigation__list,
  .header__mobile-nav .cmp-languagenavigation__list {
    max-height: unset;
    height: calc(100% - 5pc);
  }
