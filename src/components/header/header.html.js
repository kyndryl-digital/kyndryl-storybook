          ...
          <nav id="navigation-7238cfa551" class="cmp-navigation" role="navigation" itemscope="" itemtype="http://schema.org/SiteNavigationElement"
            ...
            <ul class="cmp-navigation__group">
                    ...
                    <div>
                      <div>
                        <a class="cmp-navigation__item-link cmp-navigation__item-link--landing" href="${formatUrl(
                          "us/en/services.html"
                        )}" title="Services" tabindex="0">Services</a>
                      </div>
                      ...
                      <ul class="cmp-navigation__group">
                        ...
                        <li class="cmp-navigation__item cmp-navigation__item--level-1"
                          ...
                          )}" title="Digital Workplace" data-cmp-clickable="" data-nav-right-rail="none" class="cmp-navigation__item-link cmp-navigation__item-link--level-1 "
                        ...
                        <li class="cmp-navigation__item cmp-navigation__item--level-1"
                          ...
                          )}" title="Network and Edge" data-cmp-clickable="" data-nav-right-rail="none" class="cmp-navigation__item-link cmp-navigation__item-link--level-1 " tabindex="0">Network
                            and Edge
                          </a>
                        ...
                        <li class="cmp-navigation__item cmp-navigation__item--level-1"
                          ...
                          )}" title="Security and Resiliency" data-cmp-clickable="" data-nav-right-rail="none" class="cmp-navigation__item-link cmp-navigation__item-link--level-1 "
                      ...
                      <div class="cmp-navigation__learn">
                        ...
                        <ul class="cmp-navigation__learn-list">
                          <li class="cmp-navigation__learn-list-item">
                            <a class="cmp-navigation__learn-link" href="${formatUrl(
                              "us/en/seo/plan.html"
                            )}" title="What is a business continuity plan (BCP)?" tabindex="0">
                          ...
                          <li class="cmp-navigation__learn-list-item">
                            <a class="cmp-navigation__learn-link" href="${formatUrl(
                              "us/en/seo/edge-computing.html"
                            )}" title="What is edge computing and how can it transform your business?  " tabindex="0">
                          ...
                          <li class="cmp-navigation__learn-list-item">
                            <a class="cmp-navigation__learn-link" href="${formatUrl(
                              "us/en/seo/rto.html"
                            )}" title="RTO (Recovery Time Objective) explained" tabindex="0">
                          ...
                          <li class="cmp-navigation__learn-list-item">
                            <a class="cmp-navigation__learn-link" href="${formatUrl(
                              "us/en/seo/sd-wan.html"
                            )}" title="What is SD-WAN? | Software-defined WAN (SD-WAN)" tabindex="0">
                          ...
                          <li class="cmp-navigation__learn-list-item">
                            <a class="cmp-navigation__learn-link" href="${formatUrl(
                              "us/en/seo/disaster-recovery-plan.html"
                            )}" title="What is a disaster recovery (DR) plan" tabindex="0">
              ...
              <li class="cmp-navigation__item cmp-navigation__item--level-0 cmp-navigation__item--main"
                ...
                <a href="${formatUrl(
                  "us/en/client-stories.html"
                )}" title="Customer Stories" data-cmp-clickable="" data-nav-right-rail="none" class="cmp-navigation__item-link cmp-navigation__item-link--level-0 ">Customer Stories
                </a>
              </li>
                    ...
                    <div>
                      ...
                      <ul class="cmp-navigation__group">
                        ...
                        <li class="cmp-navigation__item cmp-navigation__item--level-1"
                          ...
                          )}" title="Frequently Asked Questions" data-cmp-clickable="" data-nav-right-rail="none"
                        ...
                        <li class="cmp-navigation__item cmp-navigation__item--level-1"
                          ...
                          <a href="${formatUrl(
                            "us/en/about-us/careers.html"
                          )}" title="Join Our Team" data-cmp-clickable="" data-nav-right-rail="none" class="cmp-navigation__item-link cmp-navigation__item-link--level-1 " tabindex="-1">Join Our
                            Team
                          </a>
                        </li>
                      </ul>
              ...
              <li class="cmp-navigation__item cmp-navigation__item--level-0 cmp-navigation__item--main">
                <a href="${formatUrl("", {
                  host: "newsroom.kyndryl.com",
                })}" title="Newsroom" data-cmp-clickable="true" class="cmp-navigation__item-link cmp-navigation__item-link--level-0">Newsroom</a>
              </li>
      ...
      <ul class="cmp-navigation__group">
        ...
        <li class="cmp-navigation__item cmp-navigation__item--level-0 cmp-navigation__item--main"
          ...
          <div class="cmp-navigation__group-container cmp-navigation__group-container--level-0">
            <div class="cmp-navigation__group-wrapper">
              <div>
                <div><a class="cmp-navigation__item-link cmp-navigation__item-link--landing" href="${formatUrl(
                  "us/en/services.html"
                ...
                <ul class="cmp-navigation__group">
                  ...
                  <li class="cmp-navigation__item cmp-navigation__item--level-1"
                    ...
                    <a href="${formatUrl(
                      "us/en/services/cloud-managed.html"
                    )}" title="Cloud Services" data-cmp-clickable data-nav-right-rail="none" class="cmp-navigation__item-link cmp-navigation__item-link--level-1 ">Cloud Services </a>
                  ...
                  <li class="cmp-navigation__item cmp-navigation__item--level-1"
                    ...
                    <a href="${formatUrl(
                      "us/en/services/modernize-it.html"
                    )}" title="Core Enterprise and zCloud" data-cmp-clickable data-nav-right-rail="none" class="cmp-navigation__item-link cmp-navigation__item-link--level-1 ">Core Enterprise and
                      zCloud </a>
                  ...
                  <li class="cmp-navigation__item cmp-navigation__item--level-1"
                    ...
                    <a href="${formatUrl(
                      "us/en/services/digital-workplace.html"
                    )}" title="Digital Workplace" data-cmp-clickable data-nav-right-rail="none" class="cmp-navigation__item-link cmp-navigation__item-link--level-1 ">Digital Workplace </a>
                  ...
                  <li class="cmp-navigation__item cmp-navigation__item--level-1"
                    ...
                    <a href="${formatUrl(
                      "us/en/services/network.html"
                    )}" title="Network and Edge" data-cmp-clickable data-nav-right-rail="none" class="cmp-navigation__item-link cmp-navigation__item-link--level-1 ">Network and Edge </a>
                  ...
                  <li class="cmp-navigation__item cmp-navigation__item--level-1"
                    ...
                    <a href="${formatUrl(
                      "us/en/services/business-continuity.html"
                    )}" title="Security and Resiliency" data-cmp-clickable data-nav-right-rail="none" class="cmp-navigation__item-link cmp-navigation__item-link--level-1 ">Security and
                      Resiliency </a>
                ...
                <div class="cmp-navigation__learn">
                  ...
                  <ul class="cmp-navigation__learn-list">
                    <li class="cmp-navigation__learn-list-item">
                      <a class="cmp-navigation__learn-link" href="${formatUrl(
                        "us/en/seo/plan.html"
                      )}" title="What is a business continuity plan (BCP)?">
                        What is a business continuity plan (BCP)?
                      </a>
                    </li>
                    ...
                    <li class="cmp-navigation__learn-list-item">
                      <a class="cmp-navigation__learn-link" href="${formatUrl(
                        "us/en/seo/sd-wan.html"
                      )}" title="What is SD-WAN? | Software-defined WAN (SD-WAN)">
                        What is SD-WAN? | Software-defined WAN (SD-WAN)
                      </a>
                    </li>
                    ...
                    <li class="cmp-navigation__learn-list-item">
                      <a class="cmp-navigation__learn-link" href="${formatUrl(
                        "us/en/seo/rto.html"
                      )}" title="RTO (Recovery Time Objective) explained">
                        RTO (Recovery Time Objective) explained
                      </a>
                    </li>
                  </ul>
        ...
        <li class="cmp-navigation__item cmp-navigation__item--level-0 cmp-navigation__item--main"
          ...
          <a href="${formatUrl(
            "us/en/client-stories.html"
          )}" title="Customer Stories" data-cmp-clickable data-nav-right-rail="none" class="cmp-navigation__item-link cmp-navigation__item-link--level-0 ">Customer Stories </a>
              ...
              <div>
                ...
                <ul class="cmp-navigation__group">
                  ...
                  <li class="cmp-navigation__item cmp-navigation__item--level-1"
                    ...
                    <a href="${formatUrl(
                      "us/en/about-us/leadership.html"
                    )}" title="Leadership" data-cmp-clickable data-nav-right-rail="none" class="cmp-navigation__item-link cmp-navigation__item-link--level-1 ">Leadership </a>
                  ...
                  <li class="cmp-navigation__item cmp-navigation__item--level-1"
                    ...
                    <a href="${formatUrl(
                      "us/en/about-us/careers.html"
                    )}" title="Join Our Team" data-cmp-clickable data-nav-right-rail="none" class="cmp-navigation__item-link cmp-navigation__item-link--level-1 ">Join Our Team </a>
      ...
      <div class="header__mobile-menu-contact">
        <div>
          <div
            ...
            <p><a title="Contact Us" href="${formatUrl("en_contactus.html", {
              host: "contact.kyndryl.com",
            })}" target="_blank">Contact Us</a><span class="traicon-icon--arrow-right"></span></p>
          ...
          <div class="cmp-social"
            ...
            <ul class="cmp-social__list">
              <li class="cmp-social__item">
                <a class="cmp-social__link" target="_blank" href="${formatUrl(
                  "company/kyndryl",
                  {
