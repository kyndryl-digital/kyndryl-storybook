...
const Template = args => {
  return html`
      <kd-header>
        ...
        <kd-nav-item slot="primary-navigation">News and Insights</kd-nav-item>
        <kd-nav-item slot="primary-navigation">Customer Stories</kd-nav-item>
        <kd-nav-item slot="primary-navigation">Careers</kd-nav-item>
