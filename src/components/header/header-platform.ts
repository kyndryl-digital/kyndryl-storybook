...
import stylesheet from './kyndrylHeader.scss';
 ...
 /**
  * Legacy Kyndryl header.
  *
  * @slot - primary-navigation
  * @slot - account-navigation
  * @slot - masthead-navigation
  */
 @customElement(`kyndryl-header-platform`)
export class kyndrylHeaderPlatform extends LitElement {
  ...
  render() {
    return html`
       <kd-header>
         ...
         ${this.showSignIn() ? html`<slot name="account-navigation" slot="account-navigation"></slot>` : ''}
  ...
  protected showSignIn(): boolean{
    const url = new URL(window.location);
 
    return url.pathname.startsWith('/platform');
  }
}
