...
export const LogoGrid = args => {
  return html`
    <div class="${settings.class_prefix}-grid-container">
      <div
        class="${settings.class_prefix}-max-col-4 ${settings.class_prefix}-xlg-col-4 ${settings.class_prefix}-lg-col-4 ${settings.class_prefix}-md-col-8 ${settings.class_prefix}-sm-col-8 ${settings.class_prefix}-xs-col-4"
      >
        <kd-modal>
          ...
          <div
            class="${settings.class_prefix}-grid-container ${settings.class_prefix}-fully-fluid ${settings.class_prefix}-no-grid-gap ${settings.class_prefix}-no-grid-padding"
          >
            <div
              class="${settings.class_prefix}-max-col-8 ${settings.class_prefix}-xlg-col-8 ${settings.class_prefix}-lg-col-8 ${settings.class_prefix}-md-col-8 ${settings.class_prefix}-sm-col-8 ${settings.class_prefix}-xs-col-4"
              style="min-height:600px"
            >
              <div
                class="${settings.class_prefix}-pt4 ${settings.class_prefix}-pr4 ${settings.class_prefix}-pb6 ${settings.class_prefix}-pl4"
              >
                <p
                  class="${settings.class_prefix}-mt0 ${settings.class_prefix}-mb4"
                >
                  <img src="https://placehold.co/200x100?text=Logo" />
                </p>
                ...
                <p class="${settings.class_prefix}-mt4">
                  <kd-button
                    type="primary"
                    icon="arrow-right"
                    href="javascript://"
                    >View partner page</kd-button
                  >
                </p>
              </div>
            </div>
            <div
              class="${settings.class_prefix}-bg-dark-white ${settings.class_prefix}-max-col-8 ${settings.class_prefix}-xlg-col-8 ${settings.class_prefix}-lg-col-8 ${settings.class_prefix}-md-col-8 ${settings.class_prefix}-sm-col-8 ${settings.class_prefix}-xs-col-4"
              style="min-height:600px"
            >
              <div
                class="${settings.class_prefix}-pt4 ${settings.class_prefix}-pr4 ${settings.class_prefix}-pb6 ${settings.class_prefix}-pl4"
              >
                <p class="${settings.class_prefix}-mt0">
                  <strong>Services Links:</strong>
                </p>
                <ul class="${settings.class_prefix}-list">
                  <li class="${settings.class_prefix}-list-item">
